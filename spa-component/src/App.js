      ...
      <div className="card-collection">
        ...
        <div className="card">
          <div className="card-content">
            ...
            <p>
              size <strong>s</strong> with 30x30
            </p>
            <p>
        ...
        <div className="card">
          <div className="card-content">
            ...
            <p>
              size <strong>m</strong> with 60x60
            </p>
            <p>
              type <strong>square</strong>
            </p>
        ...
        <div className="card">
          <div className="card-content">
            ...
            <p>
              size <strong>l</strong> with 120x120
            </p>
            <p>
              type <strong>square</strong>
            </p>
        ...
        <div className="card">
          <div className="card-content">
            <Avatar src="https://picsum.photos/400/400" size="xl" />
            <p>
              size <strong>xl</strong> with 200x200
            </p>
            <p>
              type <strong>square</strong>
            </p>
